...
// HasOrderUserr applies the HasEdge predicate on the "order_userr" edge.
func HasOrderUserr() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(OrderUserrTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, OrderUserrTable, OrderUserrColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasOrderUserrWith applies the HasEdge predicate on the "order_userr" edge with a given conditions (other predicates).
func HasOrderUserrWith(preds ...predicate.Order) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(OrderUserrInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, OrderUserrTable, OrderUserrColumn),
		)
