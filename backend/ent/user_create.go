...
func (uc *UserCreate) AddOrderUserrIDs(ids ...int) *UserCreate {
	uc.mutation.AddOrderUserrIDs(ids...)
	return uc
}

// AddOrderUserr adds the order_userr edges to Order.
func (uc *UserCreate) AddOrderUserr(o ...*Order) *UserCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uc.AddOrderUserrIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.OrderUserrIDs(); len(nodes) > 0 {
